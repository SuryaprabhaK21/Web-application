...
<body>
	...
	<section class="container content-section" id="cart">
	    ...
	    List<Cart> cart=cartDaoImplement.getProductsByUser(user.getId());
        ...
        <div class="cart-items">
	        <div class="cart-row">
	            <div class="cart-item cart-column">
	                <img class="cart-item-image" src="products/<%=c.getProductImage() %>" width="100" height="100">
	                <span class="cart-item-title"><%=c.getProductName() %></span>
	            </div>
	            <span class="cart-price cart-column">Rs.<%=c.getProductPrice() %></span>
